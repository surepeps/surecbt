...
<div class="row">
  <div class="col-md-12" style="margin-bottom: 10px;" >
      ...
      <div id="print_options">
          <a href="<?php echo site_url('admin/exam_questions_print/'.$exam_id.'/answers');?>" class="btn btn-white pull-right" id="questions_print_with_answers">
              <i class="fas fa-print"></i> &nbsp; Print With Answers
          </a>
          <a href="<?php echo site_url('admin/exam_questions_print/'.$exam_id.'/no_answers');?>" class="btn btn-white pull-right" id="questions_print_without_answers">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <select class="form-control select2" name="question_type" style="width: 100%;" id="question_type">
              ...
              <option value="fill_in_the_blanks"><?php echo 'Fill In The Blanks';?></option>
          </select>
        </div>
        <br/>
