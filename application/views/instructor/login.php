...
<head>
  ...
  <title><?php echo $this->db->get_where('settings' , array('type'=>'system_name'))->row()->description; ?> | Instructor Login Page</title>
  <!-- General CSS Files -->
          ...
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <?php endif;?>
                <form id="" action="<?php echo base_url('instructor/validate_login'); ?>" method="post" class="needs-validation">
